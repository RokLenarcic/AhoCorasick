...
class WholeWordMatchMap<T> implements StringMap<T> {
    ...
    public WholeWordMatchMap(final Iterator<String> keywords, final Iterator<? extends T> values, boolean caseSensitive) {
    ...
    public WholeWordMatchMap(final Iterator<String> keywords, final Iterator<? extends T> values, boolean caseSensitive, char[] wordCharacters) {
        boolean[] characterFlags = new boolean[65536];
    ...
    public void match(final String haystack, final MapMatchListener<T> listener) {
        ...
        if (caseSensitive) {
            ...
            if (currentNode.matchLength != 0) {
                ...
                listener.match(idx - currentNode.matchLength, idx, currentNode.value);
            }
        } else {
            while (idx < len) {
    ...
    private void init(final Iterator<String> keywords, final Iterator<? extends T> values, boolean caseSensitive, boolean[] wordChars) {
